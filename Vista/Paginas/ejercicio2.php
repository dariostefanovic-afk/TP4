    ...
    <div class="col-md-6">
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white text-center">
                <h4 class="mb-0">Ingresar Nueva Persona</h4>
            </div>
            <div class="card-body p-4">
                <form action="../action/ejercicio2.php" method="POST" id="formPersona">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="domicilio" name="domicilio" placeholder="Ej: San Martín 251">
                    </div>
